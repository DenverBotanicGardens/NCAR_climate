...
speciesL1 <- unique(polyid$GNAME)
speciesG1G2 <- unique(l1G1G2$GNAME)
intersect(species, speciesL1) #Only have spatial data on 67 species
...
setdiff(species,speciesL1) #26 are in SEINet but not L1 
setdiff(speciesL1,species) #318 are in L1 but not SEINet - oh because 
