    ...
    if(nrow(checkrecords)<10){
      NULL
        ...
        for(l in 1:10){    
            ...
            train_pHerb <- pca_herb_SAE[[herbposition[i]]][,c("decimalLongitude","decimalLatitude")]
            ...
            # me <- maxent(rasterstack_2, p=train_pEOR, a=train_bEOR)
            ...
            # gc()
            writeRaster(dismo::predict(meHerb, rasterstack_2),paste("Q:/Research/Projects/alpine-phenology/Uncertainty in niche modeling/RMaxEnt/Herbtrain_eortest",g1g2names$AcceptedName[i],l,".tif", sep=""),overwrite=TRUE)
            gc()
            ...
            out[[l]] <- list(meHerb,e,thres,g1g2names$AcceptedName[i]))
            gc()
            }
        out
        }
