...
#Write table for VisTrails field data, No! This is everything, need less
#writeout <- coloradosps[coloradosps$decimalLatitude != "",]
#write.csv(writeout, "Q:/Research/All_Projects_by_Species/aa_Shapefiles_Maps/aa_ArcMap_Projects/Link_EO_Herbarium_Records/FieldData_EORG1G2.csv")
