...
accuracyhistsOneperSp <- function(pathstart, probmapnames, whichones =  atleast12[atleast12!=8], SDorAVG = "Avg"){
  lapply(whichones, function(i){
    r <- raster(paste(pathstart,SDorAVG,"TiffSp",i,".tif", sep=""))
...
#Combine the replicates, avg or just all together??
