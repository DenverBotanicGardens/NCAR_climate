...
noerrorhistsofavg <- accuracyhistsOneperSp(whichones = c(atleast12[atleast12!=8],62,66), pathstart1, WithorNo = "no")
witherrorhistsofavg <- accuracyhistsOneperSp(pathstart1)
