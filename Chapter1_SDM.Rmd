...
habitatSpecificity <- function(whichones, pathstart, replicates){
  ...
  habspecificity <- do.call(rbind,lapply(whichones, function(x){
    ellipseoutwhichones <- do.call(rbind, lapply(unique(allsphabsp$HerbType[allsphabsp$SpeciesNum==x]),
                                                 function(HT){
      ellipseoutfold <- do.call(rbind,
                                lapply(unique(allsphabsp$kfold[allsphabsp$HerbType == HT &
                                                                 allsphabsp$SpeciesNum==x]), 
                                       function(k){
...
```{r}
habspEORandNoandWith[habspEORandNoandWith$HerbType=="EOR",]
