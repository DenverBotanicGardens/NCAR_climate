...
habsp <- do.call(rbind,lapply(atleast12, function(x){
  out <- do.call(rbind,lapply(1:4, function(rep){
  load(paste("Q:/Research/Projects/alpine-phenology/Uncertainty in niche modeling/RMaxEntReplicates/maxentSp",x,"kfold",rep,".Rda", sep=""))
...
habspecificity <- do.call(rbind,lapply(atleast12, function(x){
  ...
  ellipseout <- do.call(rbind,lapply(1:4, function(rep){
