...
Herbpointsout@data
# Don't need to Map becuase put dist and area in data frame
...
# $x=areas; $y=distances; $z. ...=herb points HAD_all2
# Want to add $x and $dist to anim_all
foo1 <-HAD_all2[which(c(HAD_all2$Taxon,HAD_all2,HAD_all2$z.specificEpithet) %in% anim_all$GNAME), 
     
                                       c("x","y")] #next "z.specificEpithet" 

testlength <- lapply(animatepca_data, function())
```
