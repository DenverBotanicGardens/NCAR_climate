...
grViz("digraph flowchart {
    ...
    node [shape=plain];
      ...
      [1]: 'Herbarium specimens (Observed data) &gamma;&#x2081;'
      [2]: 'SDM (Process) &eta;'
      [3]: 'Sampling design'
...
grViz("digraph flowchart {
      ...
      [1]: 'Herbarium specimens (Observed data)'
      [2]: 'SDM (Process)'
      [3]: 'Sampling design'
      [4]: c('Annual Precipition','Annual Temperature','Precip of coldest quarter','Mean temp of coldest quarter','Elevation')
      ")
...
random_sampling <- function(suitability.raster, samplesize){
  ...
  while(i <= samplesize){
    ...
    if(getValues(suitability.raster)[randcell] > 0.3 & 
