...
### systematic 
systematic_sampling <- function(suitability.raster,  samplesize, studyarea){
  ...
  evenstep <- studyarea^2/(samplesize*100) 
  sampleout <- c()
...
for(x in 1:10){
  samplesys1 <- systematic_sampling(predic_raster, 100, 50)
