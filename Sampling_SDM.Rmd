...
lik <- function(parm){
  ...
  datapsi <- exp(beta0 + beta1*rasterstack_norm[[1]][y==1] + rasterstack_norm[[2]][y==1]*beta2 -
                    rasterstack_norm[[3]][y==1]*beta3 + rasterstack_norm[[4]][y==1]*beta4 -
                    rasterstack_norm[[5]][y==1]*beta5 + rasterstack_norm[[6]][y==1]*beta6)/
    (1 + exp(beta0 + beta1*rasterstack_norm[[1]][y==1] + rasterstack_norm[[2]][y==1]*beta2 -
                    rasterstack_norm[[3]][y==1]*beta3 + rasterstack_norm[[4]][y==1]*beta4 -
                    rasterstack_norm[[5]][y==1]*beta5 + rasterstack_norm[[6]][y==1]*beta6))
...
# minimize it
out <- nlm(lik, c(rep(0,7)), hessian=TRUE)
out$estimate
