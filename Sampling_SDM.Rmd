...
lapply(c(3,10, 20, 30, 50, 100), function(sampsize){
    # maxent_sampling(rasterstack = rasterstack_norm, true.dist = predic_raster_quad_noBio1, sampling_type = "random", reps = 100, samplesize = sampsize, pathstart = pathstart)
    
    maxent_sampling(rasterstack = rasterstack_norm, true.dist = predic_raster_quad_noBio1, sampling_type = "system", reps = 100, samplesize = sampsize, pathstart = pathstart)
    
    # maxent_sampling(rasterstack = rasterstack_norm, true.dist = predic_raster_quad_noBio1, sampling_type = "convenience", reps = 100, samplesize = sampsize, pathstart = pathstart)
    
    # maxent_sampling(rasterstack = rasterstack_norm, true.dist = predic_raster_quad_noBio1, sampling_type = "cluster", reps = 100, samplesize = sampsize, pathstart = pathstart)
})
