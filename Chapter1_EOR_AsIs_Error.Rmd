...
maxentarguments = FALSE
filenames = "EOR_bg5000"
predictorvariables = rasterstack
pathstart = pathstart
backgroundscale = 5000
distdistribution <- rpois(1000,100)


rm(spatialpointsdataframe_herb,whichones,numberofReps,error,Whichproj4string,maxentarguments,filenames,predictorvariables,backgroundscale)
...
# spatialpointsdataframe_herb will be turned into a spatialpointsdataframe from x =  "decimalLongitude" and y = "decimalLatitude as the coords"
# distXsp_justEOR <- mapply('[[', distXsp_EOR, 2)
# distXsp_justEOR <- lapply(atleast12, function(x){
#   out <- data.frame(distXsp_justEOR[x])
