...
plot(toplot, border="red", lwd=2)
points(g1g2now$decimalLongitude, g1g2now$decimalLatitude, pch=16, cex = 0.5)


plot(g1g2now$decimalLongitude, g1g2now$decimalLatitude, pch=16, cex = 0.5)
...
load(paste(pathstart, "habsp_bigbg.Rda", sep=""))
```
...
habspe <- merge(habsp_smallbg, tab1, by.x = "SpeciesNum", by.y = "SpNum1")
