...
ggplot(tab1_cells, aes(log(DistAvg.Dist), CellsOccupied, colour = Dataset))+
  geom_jitter(width=.5)+
  stat_smooth(method = "lm")+
  theme_bw()
...
ggplot(habspebig, aes(y = habspec/1000, x = log(CellsOccupied), colour = HerbType, shape=HerbType))+
  ...
  scale_color_manual(values=c("grey50","black","white"),  # "slateblue", "#E69F00", "orangered"
                       name="Dataset",
...
# was fig 3??
ggsave(filename = "C:/Users/deprengm/OneDrive - Denver Botanic Gardens/P drive/My Documents/UCDenver_phd/Dissertation/Uncertainty data source Chapter XX/fig4_20200305_AUC.png", fig3, width = 150, height = 80, dpi = 300, units = "mm", device='png')
