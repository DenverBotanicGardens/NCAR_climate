...
Test maxentrun function for EOR and combined
```{r}
spatialpointsdataframe_herb <- distXsp_justEOR_forspdf
x <- atleast12[1]
...
stitchtogether(atleast12, pathstart=pathstart, patternmatch = patternmatchbig[x], rasternames = rasternames[4])
