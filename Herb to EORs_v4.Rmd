...
Maxent46species <- lapply(1:length(pca_data2), function(i){
  ...
  for(l in 1:10){     #Are 10 repeats for 10 fold enough?
      ...
      writeRaster(dismo::predict(me, stackmini),paste("Q:/Research/Projects/alpine-phenology/Uncertainty in niche modeling/NicheModels/EOR",g1g2names$AcceptedName[i],l,".tif"))
      
      writeRaster(dismo::predict(meHerb,
                                 stackmini),paste("Q:/Research/Projects/alpine-phenology/Uncertainty in niche modeling/NicheModels/Herb",g1g2names$AcceptedName[i],l,".tif"))
      gc()
      thres <- dismo::threshold(e)  
      out[[l]] <- list(test,me,e,thres)
      gc()
  }
  out
})
