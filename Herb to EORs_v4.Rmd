...
for(i in 61:68){
  ...
  plot(l1G1G2and[l1G1G2and$GNAME %in% c(g1g2names61_68$AcceptedName[i-60],
                                        g1g2names61_68$Taxon[i-60]),] , add=TRUE, border="red")
}

for(i in 1:10){
  
  plot(colocounties.UTM)
  plot(l1G1G2[l1G1G2$GNAME %in% c(g1g2names$AcceptedName[i],
                                        g1g2names$Taxon[i]),] , add=TRUE, border="red")
}
```
