...
# ggplot(HAD_all2[HAD_all2$y<500000&HAD_all2$z.year>1800&
#                   !is.na(HAD_all2$New.Genus),], aes(as.factor(New.Genus), log(y/1000), colour=as.numeric(as.factor(New.Species))))+
#   geom_boxplot()+
#   theme_bw()+
#   geom_jitter(position = position_jitter(0.2), pch=16, cex=0.5)+
#   ylab("Distance log(km) to nearest EOR")+
#   xlab("Genus")+
...
lattice::xyplot((y/1000) ~ z.year|as.factor(New.Genus), HAD_all2[HAD_all2$y<500000&HAD_all2$z.year>1800&
                                                              !is.na(HAD_all2$New.Genus),],
                ylab="Distance log(km) to nearest EOR",
                type = c("g","p","r"),
                index = function(x,y) coef(lm(y ~ x))[1],
                xlab="Year")
