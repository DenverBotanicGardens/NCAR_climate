...
distXsp_noEORgrid68 <- lapply(notnulls68[notnulls68!=8], function(i){
  gc()
  g1g2now <- colospsall[colospsall$scientificName %in%
                                c(g1g2namesall68$Taxon[i],g1g2namesall68$AcceptedName[i])&
                                !is.na(colospsall$decimalLatitude),]
