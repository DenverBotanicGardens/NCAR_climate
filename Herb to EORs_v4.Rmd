...
thres_all <- lapply(Maxent46species[lapply(Maxent46species, length)>0], function(x){
  species <- sapply(x, '[[', 8)
  EOR_th <- sapply(x, '[[', 6)
  Herb_th <- sapply(x, '[[', 7)
  ...
  herbout <- data.frame(threshold=HERB_ss,Species=paste("EOR",gsub(" ","_",species),1:10,sep=""))
...
spRasterEORvsHerb <- lapply(unlist(sapply(maxentspecies, '[[', 8)[8,]),
  ...
  spRasterEORvsHerb[[1]][[1]][[1]]@data@names   #!!! Yes!
...
plot(spRasterEORvsHerb[[1]][[1]][[1]] > 
       thres_all[which(sapply(thres_all, '[[', 2) == spRasterEORvsHerb[[1]][[1]][[1]]@data@names)], 
