...
# save(distXsp_chunck1, file= "Q:/Research/Projects/alpine-phenology/Uncertainty in niche modeling/Data/distXsp_chunk1.Rda")
...
for(i in 1:60){
  plot(foo[[i]]@coords,
       main=foo[[i]]@data$scientificName[1])
}

# Herb = 2 and EOR = 1
lapply(notnull[-45], function(d){
