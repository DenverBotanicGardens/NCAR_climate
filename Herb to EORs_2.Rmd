...
#2 change all SEINet names to accepted, go by TPL for simplicity 
colonames$toaccepted <- paste(colonames$New.Genus,colonames$New.Species,
                              sep =" ")
#coloradosps$scientificName <-
#  multisub(colonames$Taxon[colonames$Taxonomic.status=="Synonym"],
#           colonames$toaccepted[colonames$Taxonomic.status=="Synonym"],
#           coloradosps$scientificName)
#write.csv(coloradosps, "Q:/Research/All_Projects_by_Species/aa_Shapefiles_Maps/aa_ArcMap_Projects/Link_EO_Herbarium_Records/SEINET G1 G2 Vouchers/occurrences_accepted.csv")
coloradosps <- read.csv("Q:/Research/All_Projects_by_Species/aa_Shapefiles_Maps/aa_ArcMap_Projects/Link_EO_Herbarium_Records/SEINET G1 G2 Vouchers/occurrences_accepted.csv")
...
#Use TPL to make a list of names and there synonyms - but need the full list, so need usda?
