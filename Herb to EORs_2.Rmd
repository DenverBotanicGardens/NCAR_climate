...
# Want SEINet species that are G1G2s. Synonyms are in "allnames"
species <- unique(coloradosps$scientificName)
match(sort(intersect(species, allnames)), 
      sort(intersect(allnames, species))) 
